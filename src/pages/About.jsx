...
export default function About() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-24 font-sans text-left">
      ...
      <ScrollReveal className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-inst-navy tracking-tight leading-tight">
      ...
      <ScrollReveal className="bg-slate-50 border border-slate-200/40 rounded-3xl p-8 md:p-12 space-y-8">
        <div className="max-w-3xl space-y-4">
          <span className="text-xs font-bold uppercase tracking-wider text-ember-coral bg-ember-coral/5 px-3 py-1.5 rounded-full inline-block">
            Hikayemiz
          </span>
          <h2 className="text-2xl md:text-3xl font-bold text-inst-navy">
        ...
        <div className="lg:col-span-6 grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm space-y-3">
            ...
            <p className="text-[11px] text-slate-550 leading-relaxed font-medium">
              Tüm bağış geçmişi, dönemsel gelirler ve harcama dökümleri tek tıkla resmi PDF ve Excel formatlarında dışa aktarılabilir durumdadır.
            </p>
          </div>
      ...
      <ScrollReveal className="bg-slate-50/70 border border-slate-200/40 rounded-3xl p-8 md:p-12 space-y-10">
        <div className="text-center max-w-xl mx-auto">
          <span className="text-xs font-bold uppercase tracking-wider text-pine-teal bg-pine-teal/5 px-3 py-1.5 rounded-full inline-block mb-3">
